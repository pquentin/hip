...
class TestUtil(object):
    ...
    @patch("urllib3.util.ssl_.create_hip_context")
    def test_ssl_wrap_socket_creates_new_context(self, create_hip_context):
        socket = object()
        ssl_wrap_socket(sock=socket, cert_reqs="CERT_REQUIRED")

        create_hip_context.assert_called_once_with(None, "CERT_REQUIRED", ciphers=None)
