...
def create_hip_context(ssl_version=None, cert_reqs=None, options=None, ciphers=None):
    ...
    If you wish to enable SSLv3, you can do::
        ...
        context = ssl_.create_hip_context()
...
def ssl_wrap_socket(
    ...
    :param ssl_context:
        ...
        be created using :func:`create_hip_context`.
    :param ciphers:
    ...
    if context is None:
        ...
        # this code.
        context = create_hip_context(ssl_version, cert_reqs, ciphers=ciphers)
